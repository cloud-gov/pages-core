...
describe('TemplateResolver', () => {
  it('returns a template from templates object when supplied a valid template name', () => {
  ...
  it('throws an error object when a template cannot be found', () => {
    expect(TemplateResolver.getTemplate.bind(TemplateResolver, 'not-a-template')).to.throw(Error);
  });
});
