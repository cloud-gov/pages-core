      ...
      factory.user()
        ...
        .then((repositories) => {
          ...
          repositories.forEach(r => {
            const full_name = r.full_name.split('/');
            sites.push(factory.site({ owner: full_name[0], repository: full_name[1], users: [user] }));
          })
      ...
      const repository = 'repo';
        ...
        .then((collaborators) => {
          ...
          collaborators.forEach(collab => {
            users.push(factory.user({ username: collab.login }))
          });
