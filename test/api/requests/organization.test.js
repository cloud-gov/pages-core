...
describe('Organization API', () => {
  ...
  describe('POST /v0/organization/:id/invite', () => {
    ...
    it('returns the member and the invitation details for cloud.gov origin on invite', async () => {
      const uaaEmail = 'foo@bar.com';
      const roleId = userRole.id;
    ...
    it('returns the member and the invitation details for cloud.gov origin on resend', async () => {
      const uaaEmail = 'foo@bar.com';
      const roleId = userRole.id;
      const origin = 'cloud.gov'
      const isResend = true;
