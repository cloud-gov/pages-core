...
const addBuildTokenColumn = db => new Promise((resolve, reject) => {
...
const loadBuilds = db => new Promise((resolve, reject) => {
...
const addNullConstraint = db => new Promise((resolve, reject) => {
