...
function uaaInvite({ link }) {
  return layout(`
    ...
    <ol>
      ...
      <li>
        <strong>Read the documentation</strong> - After you register and log in, review the <a href="https://federalist.18f.gov/documentation/customer-responsibilities">customer responsibilities </a> <sup>[4]</sup>.
      </li>
      <li>
    ...
    <ul>
      ...
      <li>[4] Customer responsibilities: https://federalist.18f.gov/documentation/customer-responsibilities</li>
