...
1. [Register a new OAuth application on GitHub](https://github.com/settings/applications/new). Give your app a name and "Homepage URL" (`http://localhost:1337`, e.g.), and use `http://localhost:1337/auth/github/callback` as the "Authorization callback url".
