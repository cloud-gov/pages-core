...
#      ie: npm run migrate-site-repo <siteId> <email> <owner> <repository>
#   [--name] Optional: Name to give the task (generated if omitted)

## Example migration
$ cf run-task pages-<env> --command "npm run migrate-site-repo 1 user@agency.gov agency-org site-repo" --name site-1-migrate
