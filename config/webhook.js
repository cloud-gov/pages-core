...
module.exports = {
  ...
  secret: validateEnvVarSecret(env.GITHUB_WEBHOOK_SECRET, 'GITHUB_WEBHOOK_SECRET'),
  gitlabEndpoint: env.GITLAB_WEBHOOK_URL || 'https://pages-dev.cloud.gov/webhook/gitlab',
  gitlabSecret: validateEnvVarSecret(env.GITLAB_WEBHOOK_SECRET, 'GITLAB_WEBHOOK_SECRET'),
};
