module.exports = {
  'uswds-11ty': {
    ...
    branch: 'main',
    engine: 'node.js',
    example: 'https://uswds-11ty.pages.cloud.gov',
    title: '11ty - U.S. Web Design System v3.0',
    description:
      // eslint-disable-next-line max-len
      'A flexible multi-page setup intended to introduce an agency or program. It offers an engaging Hero section for a current priority and a landing page layout designed to provide clarity and context for first time visitors. This template also offers navigation options for internal pages.',
  ...
  'workshop-uswds-11ty': {
    ...
    engine: 'node.js',
    example: 'https://uswds-11ty.pages.cloud.gov',
    title: 'Workshop - 11ty - U.S. Web Design System v3.0',
    description:
      // eslint-disable-next-line max-len
      'A flexible multi-page setup intended to introduce an agency or program. It offers an engaging Hero section for a current priority and a landing page layout designed to provide clarity and context for first time visitors. This template also offers navigation options for internal pages.',
    thumb: '/images/pages-uswds-v3-11ty-thumbnail.png',
    templateSourceCodeUrl: 'https://workshop.cloud.gov/cloud-gov/pages/pages-uswds-11ty',
  },
};
