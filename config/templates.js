module.exports = {
  'uswds-11ty': {
    ...
    branch: 'main',
    engine: 'node.js',
    example: 'https://federalist-32bdb3ca-a71a-46e5-ab20-a38ecfdbf143.sites.pages.cloud.gov/site/cloud-gov/pages-uswds-11ty/',
  ...
  'uswds-jekyll': {
    ...
    branch: 'main',
    engine: 'jekyll',
    example: 'https://federalist-2b713ce7-4dcb-481c-b2fd-2e0724e66911.sites.pages.cloud.gov/site/cloud-gov/pages-uswds-jekyll/',
  ...
  'uswds-gatsby': {
    ...
    branch: 'main',
    engine: 'node.js',
    example: 'https://federalist-64abcbda-b748-4757-908d-641206f264e4.sites.pages.cloud.gov/site/cloud-gov/pages-uswds-gatsby/',
