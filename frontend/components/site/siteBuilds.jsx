        ...
        : (
          <div className="table-container">
            ...
            >
              ...
              <tbody>
                {builds.data.map((build, i) => {
                  return (
                    <SiteBuildsBuild build={build} showBuildTasks={siteHasBuildTasks(builds)}
                    previewBuilds={previewBuilds} siteHasBuildTasks={siteHasBuildTasks(builds)} site={site} key={i} />
                  )
                })}
              </tbody>
            </table>
