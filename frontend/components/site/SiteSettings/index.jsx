      ...
      <div>
        <p>
          ...
          <a target="_blank" 
            ...
            href="https://federalist-docs.18f.gov/pages/using-federalist/#managing-site-settings">these settings
          </a> or
          <a target="_blank" 
            rel="noopener noreferrer" 
            title="Federalist documentation on previews"
            href="https://federalist-docs.18f.gov/pages/using-federalist/previews/">viewing site previews
          </a>.
        </p>
