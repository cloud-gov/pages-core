...
const ZapAbout = () => (
  <>
    ...
    <p>
      ...
      {' '}
      passively scans your published website for common security vulnerabilities, but does not perform any attack or attempt to maliciously modify your site code. This scan may find evidence of issues such as the unintended exposure of sensitive data, SQL injection opportunities, cross-site scripting (XSS) flaws, and the use of components with known vulnerabilities.
    </p>
  </>
);
  ...
  return (
    <>
      <p>
        ...
        {' '}
        published by the World Wide Web Consortium (W3C) to websites and web applications,  where possible. This accessibility scan checks each webpage for violations of the latest WCAG version,  currently
        {' '}
      ...
      <p>
        This scan uses the open source axe-core project to identify common violations. With axe-core, you may expect to find a little over 55% of WCAG issues automatically. Please remember that
        {' '}
