...
const ScanPagePathAndReportLink = ({ pagePath, pageURL = false, reportLink }) => (
  <div className="grid-row flex-align-center">
    ...
    >
      ...
      {pageURL && (
        <span className="grid-col-12 tablet:grid-col-auto flex-align-self-start">
          <a
            className="usa-link font-body-3xs text-no-wrap margin-x-2"
            target="_blank"
    ...
    >
      <Link
        className="usa-link font-body-2xs text-bold text-no-wrap"
        to={reportLink}
        path="relative"
        title={`Full results for ${pagePath}`}
      >
        View report
      </Link>
    </span>
